...
import json
import sys
import basic_ot2_gui as bot2gui
import tkinter as tk
from tkinter import filedialog
import mplates

# Constant str
CSV_PATH = r"C:\Users\mh2210\Box Sync\Work_box\Python\OT2\repo\test\2019-05-30_updated_construct_csvs"
...
def main():
    ...
    generate_master_mix_xlsx(clips_df['number'].sum(), MASTER_MIX_FNAME)
...
def generate_master_mix_xlsx(clip_number, master_mix_fname):
