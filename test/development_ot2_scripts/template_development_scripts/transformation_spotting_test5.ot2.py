...
def generate_transformation_wells(spotting_tuples):
    ...
    spotting_tuples (tuple): Sets of spotting reactions are given 
        in the form: ((source wells), (target wells), (spotting volumnes)). 
...
def transformation_setup(transformation_wells):
    ...
    ROBOT_DELAY = 20  # Delay (sec) to prevent prior pause skipping.
    ...
    p10_pipette.delay(seconds=ROBOT_DELAY)
    tempdeck.deactivate()
...
# python transformation_spotting_test5.ot2.py
