...
main_dict = {"prefix_linker_wells": ["C4", "A8", "C8", "D8", "A4", "C4", "A8", "C8", "D8", "A4", "C4", "A8", "C8", "D8", "A4", "C4", "A8", "C8", "D8", "A4", "B4", "C4", "A8", "C8", "D8", "A4", "B4", "C4", "A8", "C8", "D8", "A4", "B4"], "suffix_linker_wells": ["E8", "G8", "H8", "G6", "F4", "E8", "G8", "H8", "G6", "F4", "E8", "G8", "H8", "G6", "F4", "E8", "G8", "H8", "G6", "E4", "F4", "E8", "G8", "H8", "G6", "E4", "F4", "E8", "G8", "H8", "G6", "E4", "F4"], "part_wells": ["A6", "B6", "D6", "F6", "A5", "A6", "B6", "D6", "F6", "A5", "A6", "B6", "D6", "F6", "A5", "A6", "B6", "D6", "F6", "A5", "B5", "A6", "B6", "D6", "F6", "A5", "B5", "A6", "B6", "D6", "F6", "A5", "B5"], "destination_wells": ["A1", "B1", "C1", "D1", "E1", "A2", "B2", "C2", "D2", "E2", "A3", "B3", "C3", "D3", "E3", "A4", "B4", "C4", "D4", "E4", "F4", "A5", "B5", "C5", "D5", "E5", "F5", "A6", "B6", "C6", "D6", "E6", "F6"], "part_vols": [1.3, 1.2, 1.1, 1.1, 1.6, 1.3, 1.2, 1.1, 1.1, 1.6, 1.3, 1.2, 1.1, 1.1, 1.6, 1.3, 1.2, 1.1, 1.1, 1.6, 1.2, 1.3, 1.2, 1.1, 1.1, 1.6, 1.2, 1.3, 1.2, 1.1, 1.1, 1.6, 1.2], "water_vols": [6.7, 6.8, 6.9, 6.9, 6.4, 6.7, 6.8, 6.9, 6.9, 6.4, 6.7, 6.8, 6.9, 6.9, 6.4, 6.7, 6.8, 6.9, 6.9, 6.4, 6.8, 6.7, 6.8, 6.9, 6.9, 6.4, 6.8, 6.7, 6.8, 6.9, 6.9, 6.4, 6.8], "initial_tip": "A1"}

def main(
	prefix_linker_wells: list = ['A1', 'B1'],
	suffix_linker_wells: list = ['C1', 'D1'],
	part_wells: list = ['E1', 'F1'],
	destination_wells: list = ['A1', 'B1'],
	part_vols: list = [1, 1],
	water_vols: list = [7, 7],
	initial_tip: 'String_Selection...' = 'B1'):
