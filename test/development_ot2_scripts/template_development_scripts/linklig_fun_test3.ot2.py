...
linker_ligation_dict = {"prefix_linker_wells": ["C4", "A8", "C8", "D8", "A4", "C4", "A8", "C8", "D8", "A4", "C4", "A8", "C8", "D8", "A4", "C4", "A8", "C8", "D8", "A4", "B4", "C4", "A8", "C8", "D8", "A4", "B4", "C4", "A8", "C8", "D8", "A4", "B4"], "suffix_linker_wells": ["E8", "G8", "H8", "G6", "F4", "E8", "G8", "H8", "G6", "F4", "E8", "G8", "H8", "G6", "F4", "E8", "G8", "H8", "G6", "E4", "F4", "E8", "G8", "H8", "G6", "E4", "F4", "E8", "G8", "H8", "G6", "E4", "F4"], "part_wells": ["A6", "B6", "D6", "F6", "A5", "A6", "B6", "D6", "F6", "A5", "A6", "B6", "D6", "F6", "A5", "A6", "B6", "D6", "F6", "A5", "B5", "A6", "B6", "D6", "F6", "A5", "B5",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     "A6", "B6", "D6", "F6", "A5", "B5"], "part_vols": [1.3, 1.2, 1.1, 1.1, 1.6, 1.3, 1.2, 1.1, 1.1, 1.6, 1.3, 1.2, 1.1, 1.1, 1.6, 1.3, 1.2, 1.1, 1.1, 1.6, 1.2, 1.3, 1.2, 1.1, 1.1, 1.6, 1.2, 1.3, 1.2, 1.1, 1.1, 1.6, 1.2], "water_vols": [6.7, 6.8, 6.9, 6.9, 6.4, 6.7, 6.8, 6.9, 6.9, 6.4, 6.7, 6.8, 6.9, 6.9, 6.4, 6.7, 6.8, 6.9, 6.9, 6.4, 6.8, 6.7, 6.8, 6.9, 6.9, 6.4, 6.8, 6.7, 6.8, 6.9, 6.9, 6.4, 6.8]}
...
def linker_ligation(
    ...
    destination_wells = destination_plate.wells(
        INITIAL_DESTINATION_WELL, length=int(len(part_wells)))
    ...
    pipette.transfer(1, source_plate.wells(prefix_linker_wells),
                     destination_wells, new_tip='always', mix_after=LINKER_MIX_SETTINGS)
    pipette.transfer(1, source_plate.wells(suffix_linker_wells),
                     destination_wells, new_tip='always', mix_after=LINKER_MIX_SETTINGS)
    pipette.transfer(part_vols, source_plate.wells(part_wells),
                     destination_wells, new_tip='always', mix_after=PART_MIX_SETTINGS)
