...
metadata = {
    'apiLevel': '2.10',
    'protocolName': 'Magnetic Bead Purification v2',
...
PROTOCOL_CONFIG = {
    ...
    'sample_volume': 30,    # Volume of sample in µL
    ...
    'elution_well': 'A1',   # Well position for elution buffer in reservoir
    'waste_well': 'A5',     # Well position for waste
...
def run(protocol: protocol_api.ProtocolContext):
    ...
    protocol.delay(minutes=PROTOCOL_CONFIG['incubation_times']['initial'])
    ...
    protocol.delay(minutes=PROTOCOL_CONFIG['incubation_times']['settling'])
    ...
    for wash in range(2):
        ...
        protocol.delay(minutes=PROTOCOL_CONFIG['incubation_times']['wash'])
    ...
    protocol.delay(minutes=PROTOCOL_CONFIG['incubation_times']['drying'])
    ...
    protocol.delay(minutes=PROTOCOL_CONFIG['incubation_times']['elution'])
