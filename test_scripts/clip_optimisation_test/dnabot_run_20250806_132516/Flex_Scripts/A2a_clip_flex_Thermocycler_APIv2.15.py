...
def run(protocol: protocol_api.ProtocolContext):
    ...
    # Load destination plate onto thermocycler module
    ...
    # Modified from custom labware as API 2 doesn't support labware.create anymore
    ...
    def clip(clips_dict):
        ...
        # Calculate tiprack requirements
        ...
        # Use available slots for p50 tip racks (excluding slots 1, 2 for source plates and slots 7, 8, 10, 11 for thermocycler)
        p50_tip_slots = ['3', '6', '9']  # Available slots for p50 tip racks
    ...
    tc_mod.execute_profile(steps=profile, repetitions=20)
