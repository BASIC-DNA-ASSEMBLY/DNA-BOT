...
sample_number=12
ethanol_well='A11'
__HARDWARE={"robot_type": {"id": "OT-2"}, "single_pipette": {"id": "p20_single_gen2"}, "single_pipette_mount": {"id": "right"}, "multi_pipette": {"id": "p300_multi_gen2"}, "multi_pipette_mount": {"id": "left"}, "thermocycler": {"id": "thermocyclerModuleV2"}, "mag_deck": {"id": "magneticModuleV1"}}    #CHANGE OG   "mag_deck": {"id": "magnetic module gen1"}
...
__LABWARES={"mag_plate": {"id": "4ti0960rig_96_wellplate_200ul"}, "OT-2_tiprack_20ul": {"id": "opentrons_96_tiprack_20ul"}, "OT-2_tiprack_300ul": {"id": "opentrons_96_tiprack_300ul"}, "OT-2_tiprack_1000ul": {"id": "opentrons_96_tiprack_1000ul"}, "24_tuberack_1500ul": {"id": "e14151500starlab_24_tuberack_1500ul"}, "clip_source_plate": {"id": "4ti0960rig_96_wellplate_200ul"}, "clip_plate": {"id": "4ti0960rig_96_wellplate_200ul"}, "mix_plate": {"id": "4ti0960rig_96_wellplate_200ul"}, "final_assembly_plate": {"id": "4ti0960rig_96_wellplate_200ul"}, "transform_plate": {"id": "4ti0960rig_96_wellplate_200ul"}, "agar_plate": {"id": "thermoomnitrayfor96spots_96_wellplate_50ul"}, "12_reservoir_21000ul": {"id": "4ti0131_12_reservoir_21000ul"}, "96_deepwellplate_2ml": {"id": "4ti0136_96_wellplate_2200ul"}, "12_corning_wellplate": {"id": "corning_12_wellplate_6.9ml_flat"}}
#   CHANGE: MAG PLATE ADDED TO LABWARES DICT
...
#requirements = {"robotType": __HARDWARE['robot_type']['id'], "apiLevel": "2.21"} # checking if this line is the problrm
...
def run(protocol: protocol_api.ProtocolContext):
    ...
    if robot_type=='Flex':
        ...
        tiprack_1000 = __LABWARES['OT-2_tiprack_1000ul']['id']
    else:
        raise ValueError("Invalid robot type. Must be 'OT-2' or 'Flex'.")

    def magbead(sample_number, ethanol_well):  #CHANGE DELETED ALL TRAILING COMMA
        # sample_number,
        # ethanol_well,
        elution_buffer_well='A1'
        sample_volume=30    #CHANGE REMOVED COMMA
        ...
        sample_offset=0   #CHANGE COMMA REMOVED
...
### Loading Tiprack
        ...
        if PIPETTE_TYPE=="Flex_8channel_1000":
            ...
            #pipette.max_volume = 300      CHANGE READ ONLY
        else: 
        ...
        ethanol = reagent_container[ethanol_well]      #CHANGE OG ethanol = reagent_container.wells(ethanol_well)
        ...
        for target in range(col_num):
            ...
            pipette.drop_tip()   # CHANGE DELETED TRASH
        ...
        def get_flex_tip():      # CHANGE, OG: def get_flex_tip(tip_index):
            nonlocal tip_index     #CHANGE global to nonlocal
        ...
        def get_ot2_tip():                     # CHANGE, OG: def get_ot2_tip(tip_index):
            nonlocal tip_index          #CHANGE global to nonlocal
        ...
        for cycle in range(2):
            ...
            pipette.pick_up_tip(tip)    #CHANGE ADDED LINE
            # CHANGE OG:
            # for target in samples:
            #     if robot_type == 'Flex':
            ...
            #     pipette.distribute(ETHANOL_VOL, ethanol.bottom(2), target[0].bottom(5), air_gap=air_vol, new_tip='never')    # CHANGE OG pipette.distribute(ETHANOL_VOL, ethanol.bottom(2), target.bottom(5), air_gap=air_vol, new_tip='never')
            #     pipette.return_tip()  # Return tip for reuse within the cycle
            for col in samples:
                well = col[0]  # pick the first well of the column
                pipette.distribute(ETHANOL_VOL, ethanol.bottom(2), well.bottom(5), air_gap=air_vol, new_tip='never')
            pipette.drop_tip()

    # CHANGE indent for many lines below
            protocol.delay(minutes=WASH_TIME)
