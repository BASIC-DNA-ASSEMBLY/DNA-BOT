...
clips_dict={"prefixes_wells": ["B8", "B7", "C7", "C4", "C10", "C11", "C12", "C5", "C6"], "prefixes_plates": ["2", "2", "2", "2", "2", "2", "2", "2", "2"], "suffixes_wells": ["A7", "C2", "C1", "C3", "A8", "A8", "A8", "C3", "C3"], "suffixes_plates": ["2", "2", "2", "2", "2", "2", "2", "2", "2"], "parts_wells": ["A1", "A4", "A8", "A6", "A7", "A7", "A7", "A6", "A6"], "parts_plates": ["5", "5", "5", "5", "5", "5", "5", "5", "5"], "parts_vols": [1, 1, 1, 1, 1, 1, 1, 1, 1], "water_vols": [7.0, 7.0, 7.0, 7.0, 7.0, 7.0, 7.0, 7.0, 7.0]}
